...
// here lets get fflfl the vjumpup
        ...
        Andre.lUp = (Animator anim, GameObject charaObj, int di) => { // 
            GameObject attack = charaObj.transform.GetChild(0).gameObject;
        ...
        Andre.lDown = (Animator anim, GameObject charaObj, int di) => { // 
            GameObject attack = charaObj.transform.GetChild(0).gameObject;
        ...
        Andre.hForward = (Animator anim, GameObject charaObj, int dir) => { // this is how we get chara position
            charaObj.transform.GetChild(1).gameObject.name = charaObj.name + "Hit" + Andre.heavyAttackForwardValue.ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (0).ToString() + "T" + "0.8"; // i fixed 
            Debug.Log("hForward from " + charaObj.name);
            charaObj.transform.GetChild(2).name = charaObj.name + "Hit" + Andre.heavyAttackForwardValue.ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (0).ToString() + "T" + "0.8"; // i fixed 
            Debug.Log("hForward from " + charaObj.name);
            charaObj.transform.GetChild(3).name = charaObj.name + "Hit" + Andre.heavyAttackForwardValue.ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (0).ToString() + "T" + "0.8"; // i fixed 
            Debug.Log("hForward from " + charaObj.name);
            
        };
        Andre.hBackward = (Animator anim, GameObject charaObj, int dir) => { // this is how we get chara position
            charaObj.transform.GetChild(1).gameObject.name = charaObj.name + "Hit" + Andre.heavyAttackBackValue.ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (0).ToString() + "T" + "0.8"; // i fixed 
            Debug.Log("hForward from " + charaObj.name);
            
        };
        Andre.hUp = (Animator anim, GameObject charaObj, int dir) => { // this is how we get chara position
            charaObj.transform.GetChild(1).gameObject.name = charaObj.name + "Hit" + Andre.heavyAttackUpValue.ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (10).ToString() + "T" + "0.8"; // i fixed 
            Debug.Log("hForward from " + charaObj.name);
            
        };
        Andre.hDown = (Animator anim, GameObject charaObj, int dir) => { // this is how we get chara position
            charaObj.transform.GetChild(1).gameObject.name = charaObj.name + "Hit" + Andre.heavyAttackDownValue.ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (10).ToString() + "T" + "0.8"; // i fixed 
            Debug.Log("hForward from " + charaObj.name);
        ...
        FLLFFL.lForward = (Animator anim, GameObject charaObj, int dir) => { // this is how we get chara position
            GameObject attack = charaObj.transform.GetChild(1).gameObject;
            attack.name = charaObj.name + "Hit" + FLLFFL.lightAttackForwardValue.ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (0).ToString() + "T" + "0.8";// + "Anim"; // i fixed 
            Debug.Log("lForward from " + charaObj.name);
            
        };
        FLLFFL.lBackward = (Animator anim, GameObject charaObj, int dir) => { // 
            GameObject attack = charaObj.transform.GetChild(1).gameObject;
            attack.name = charaObj.name + "Hit" + FLLFFL.lightAttackBackValue.ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (0).ToString() + "T" + "0.8";// + "Anim"; // i fixed 
            Debug.Log("lBackward from " + charaObj.name);
            // aman i changed the bool to an int so we can just multiply to change te direction of attack
        ...
        FLLFFL.lUp = (Animator anim, GameObject charaObj, int dir) => { // 
            GameObject attack = charaObj.transform.GetChild(1).gameObject;
            attack.name = charaObj.name + "Hit" + FLLFFL.lightAttackUpValue.ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (10).ToString() + "T" + "0.8";// + "Anim"; // i fixed 
            Debug.Log("lUp from " + charaObj.name);
            // aman i changed the bool to an int so we can just multiply to change te direction of attack
            // ok 
        }; // lets got to playercontroller
        FLLFFL.lDown = (Animator anim, GameObject charaObj, int dir) => { // 
            GameObject attack = charaObj.transform.GetChild(1).gameObject;
            attack.name = charaObj.name + "Hit" + FLLFFL.lightAttackDownValue.ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (10).ToString() + "T" + "0.8";// + "Anim"; // i fixed 
            Debug.Log("lDown from " + charaObj.name);
            // aman i changed the bool to an int so we can just multiply to change te direction of attack
            // ok 
        }; // lets got to playercontroller
        ...
        FLLFFL.hForward = (Animator anim, GameObject charaObj, int dir) => { // this is how we get chara position
            GameObject attack = charaObj.transform.GetChild(1).gameObject;
            attack.name = charaObj.name + "Hit" + FLLFFL.heavyAttackForwardValue.ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (0).ToString() + "T" + "0.8";// + "Anim"; // i fixed 
            Debug.Log("hForward from " + charaObj.name);
            
        };
        FLLFFL.hBackward = (Animator anim, GameObject charaObj, int dir) => { // 
            GameObject attack = charaObj.transform.GetChild(1).gameObject;
            attack.name = charaObj.name + "Hit" + FLLFFL.heavyAttackBackValue.ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (0).ToString() + "T" + "0.8";// + "Anim"; // i fixed 
        ...
        FLLFFL.hUp = (Animator anim, GameObject charaObj, int dir) => { // 
            ...
            attack1.name = charaObj.name + "Hit" + (FLLFFL.heavyAttackUpValue/2).ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (10).ToString() + "T" + "0.8";// + "Anim"; // i fixed 
            GameObject attack2 = charaObj.transform.GetChild(2).gameObject;
            attack2.name = charaObj.name + "Hit" + (FLLFFL.heavyAttackUpValue).ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (10).ToString() + "T" + "0.8";// + "Anim"; // i fixed 
        ...
        FLLFFL.hDown = (Animator anim, GameObject charaObj, int dir) => { // 
            GameObject attack = charaObj.transform.GetChild(1).gameObject;
            attack.name = charaObj.name + "Hit" + FLLFFL.heavyAttackDownValue.ToString() + "Knock" + "X" + (10*(dir)).ToString() + "Y" + (10).ToString() + "T" + "0.8";// + "Anim"; // i fixed 
